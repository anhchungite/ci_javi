...
<head>
    ...
    <!-- Bootstrap CSS -->    
    <link href="<?php echo TEMPLATE_ADMIN?>/css/bootstrap.min.css" rel="stylesheet">
    <!-- bootstrap theme -->
    ...
    <link href="<?php echo TEMPLATE_ADMIN?>/css/font-awesome.css" rel="stylesheet" />
    <!-- Custom styles -->
...
$imgRand = rand(1, 13);
?>
  <body class="login-img-body" style="background: url('<?php echo TEMPLATE_ADMIN?>/img/bg-<?php echo $imgRand?>.jpg') no-repeat center center fixed; ">
