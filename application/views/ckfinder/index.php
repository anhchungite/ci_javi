...
<head>
	...
	<script type="text/javascript" src="<?php echo TEMPLATE_ADMIN?>/assets/ckfinder/ckfinder.js"></script>
	<style type="text/css">
...
(function()
{
		...
		config.connectorPath = "<?php echo base_url('ckfinder/admin_ckfinder/connector')?>";
