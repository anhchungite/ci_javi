               ...
               <table class="table table-striped table-advance table-hover">
                  <tbody>
                     ...
                     <?php
                        ...
                        ?>	
                     <tr>
                        <td class="col-lg-1"><input type="checkbox" class="check_item" name="checklist[]" value="<?php echo $id_contact ?>"/></td>
                        <td class="col-lg-1"><?php echo $id_contact ?></td>
                        <td class="col-lg-2"><a href="<?php echo base_url()?>admin/admin_contact/view/<?php echo $id_contact ?>"><?php echo $name ?></a></td>
                        <td class="col-lg-2"><?php echo $email ?></td>
                        <td class="col-lg-2"><?php echo $date ?></td>
                        <td class="col-lg-1">
                           <?php 
                              if($status == 1){
                              ?>
